        ...
        return(
          ...
          >
              ...
              <TabBarIOS.Item
               ...
               title="首页"
               selected={this.state.Maintitl=='首页'}
              ...
              <TabBarIOS.Item
                  ...
                  title="消息"
                  selected={this.state.Maintitl=='消息'}
                  onPress={()=>{this.setState({
                  Maintitl:'消息'
              })}}
              >
              ...
              <TabBarIOS.Item
                  ...
                  title="发现"
                  selected={this.state.Maintitl=='发现'}
                  onPress={()=>{this.setState({
                  Maintitl:'发现'
              })}}
              >
              ...
              <TabBarIOS.Item
                  ...
                  title="我的"
                  selected={this.state.Maintitl=='我的'}
                  onPress={()=>{this.setState({
                  Maintitl:'我的'
              })}}
              >
